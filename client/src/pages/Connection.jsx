...
const Connection = () => {
  ...
  const dataArray = [
    ...
    { lable: 'Pending', value: pendingconnecton, icon: UserRoundPen },
          ...
          {dataArray.map((tab) => (
            <button
              ...
              className={`cursor-pointer flex items-center px-3 py-1 text-sm
                rounded-md transition-colors ${currentTab === tab.lable ? 'bg-white font-medium text-black' : 'text-gray-500 hover:text-black'}`}
            >
